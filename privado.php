<!DOCTYPE html>
  ...
  <body>
    ...
    rut.setCustomValidity('');
      ...
      <div class="container">
      <form id="formulario" name="formulario" method="POST" action="php/submitpriv.php" enctype="multipart/form-data" onsubmit="return Comprobar()">
      <div class="container">
...
<!--------------------------------------------------------------------------------->            
            ...
            <h6 class="alert alert-secondary col-md-3">Duración Total (en meses, máximo 36 meses):</h6><input type="text" name="duracionSede" class="form-control col-md-1" maxlength="2"><br>
            ...
            <h6 class="alert alert-secondary col-md-5">(Comunas y localidades de la Región de O'Higgins donde se ejecutarán las
              actividades) </h6>
            <input type="text" name="lugar_ejecucion" class="form-control col-md-4"><br>
...
<!-- ITEM 4 -->
        ...
        <tr>
          ...
          <td class="archivo1"></td>
          <td class="archivo1"><input type="file" required="" name="archivo16" id="archivo16"></td>
        </tr>
        </tbody>
