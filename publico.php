      ...
      <!-- ITEM 1 -->
        <!-- ITEM 2 -->
            ...
            <div class="row container">
              <div  align="center" class="col-md-2 border border-dark" style="background: #E2E3E5;" ><b>PROGRAMAS</b></div>
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" ></div>
            ...
            <div align="center" class="pt-2 col-md-1 border border-dark" style="background: #E2E3E5;"><input type="radio" name="options1" id="option1"></div>
            </div>
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" ></div>
            <div  class="col-md-1 border-left border-dark" style="background: #E2E3E5;" ></div>
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" >1.1 La Promoción de la Economia Circular</div>
            <div class="col-md-1 border-left border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
            ...
            <!-- 1.2 -->
            <div class="row container">
            <div  class="col-md-2 border-left border-top border-dark" style="background: #E2E3E5;" ></div>
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" >1.2 Diversificación y adaptación de los cultivos al cambio climático</div>
            <div class="col-md-1 border-left border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-bottom border-dark" style="background: #E2E3E5;" ></div>
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-bottom border-dark" style="background: #E2E3E5;" >2.1 Desarrollo de nuevos productos y servicios por parte de pequeños productores y pequeñas empresas</div>
            <div  class="col-md-1 border-left border-bottom border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
          ...
          <div class="row container">
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" >2.2 Incorporación de tecnologías, emprendimientos y servicios 4.0.</div>
            <div  class="col-md-1 border-left border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
          ...
          <div class="row container">
            ...
            <div class="row container">
            <div  class="col-md-2 border-left  border-dark" style="background: #E2E3E5;" >2.3 Puesta en valor en el mercado de los productos, servicios regionales, patrimonio arquitectónico y físico o natural.</div>
            <div  class="col-md-1 border-left  border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
          ...
          <div class="row container">
            ...
            <div class="row container">
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" >3.1 Información, Formación y Extensionismo</div>
            <div  class="col-md-1 border-left border-dark" style="background: #E2E3E5;"><input type="radio" name="options" id="option2"></div>
            ...
            <div  class="col-md-2 border-left border-dark" style="background: #E2E3E5;" ></div>
            <div  class="col-md-1 border-left border-dark" style="background: #E2E3E5;"></div>
            <div  class="col-md-4 border border-dark" style="background: #E2E3E5;" >nformación para: </div>
            <div align="center" class="pt-2 col-md-1 border border-dark" style="background: #E2E3E5;"><input type="radio" name="options1" id="option1"></div>
              ...
              <!-- ITEM 3 -->
                <!-- ITEM 4 -->
                    ...
                    <h6 class="alert alert-secondary"> (Indicar qué existe en Chile y en el extranjero relacionado con
                      ...
                      utilizadas (máximo 10.000 caracteres).</h6> <textarea rows="7" name="problema" cols="123"
                      maxlength="10000" style=" resize:none;" required=""
                      placeholder="Máximo 10.000 caracteres"></textarea><br><br>
                    ...
                    <h6 class="alert alert-secondary"> (Deberá indicar la novedad, originalidad y los aspectos
                      ...
                      de innovación e inexistencia de la innovación propuesta, dentro del país o región)</h6> <textarea
                      rows="7" name="problema" cols="123" maxlength="10000" style=" resize:none;" required=""
                    ...
                    <textarea rows="7" name="metodologia" cols="123" maxlength="10000" placeholder="Máximo 10.000 caracteres" style=" resize:none;" required=""></textarea><br>
