    ...
    <script type="text/javascript">
        ...
        function llamarvalorpresu() {
            ...
            if (valorFIC > maxFIC) {
                alert("El monto solicitado no puede ser mayor que: M$240.000");
                $('#proy_presu').val('');
            }
        }
    </script>
        ...
        <script>
            function Suma() {
                ...
                if (c > 240000) {
                    alert("La suma de los campos en 'Monto Solicitado al FIC' no puede exceder los M$240.000");
            ...
            function Pecunario() {
                ...
                if (ingresoPecunario > total1) {
                    alert(
                        "Error. El valor total del 'Aporte Pecuniario' no debe ser mayor al 5% del Monto Total del Proyecto. Ingrese los datos nuevamente.");
                    ...
                    alert(
                        "Error. El valor total del 'Aporte No Pecuniario' no debe ser mayor al 5% del Monto Total del Proyecto. Ingrese los datos nuevamente.");
        ...
        <div class="container-fluid">
            ...
            <p>Ingrese el monto a financiar por el FIC para cada subítem (no puede superar los M$240.000).</p>
            <h6 class="alert alert-danger">Los valores deben ser ingresados en $M y los campos en donde no requerira presupuesto debe relleneralos con el valor de "0" </h6><br>
            ...
            <table class="table table-bordered" border="1px solid black">
                ...
                <tr>
                    <td class="verticalTableHeade r" rowspan="4" align="center"><b>Gastos de Contratación del
                            Proyecto</b></td>
                    <td class="tg-hix7">Actividades de Investigación y Desarrollo</td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso1" id="ingreso1" onkeyup="Suma()"
                            onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso11" id="ingreso11"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso21" id="ingreso21"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso31" id="ingreso31"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                <tr>
                    ...
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso22" id="ingreso22"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso32" id="ingreso32"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                <tr>
                    <td class="tg-hix7">Actividades de Desarrollo y Transferencia de Tecnologías</td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso3" id="ingreso3" onkeyup="Suma()"
                            onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso13" id="ingreso13"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso23" id="ingreso23"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso33" id="ingreso33"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                <tr>
                    <td class="tg-hix7">Otras Actividades que guarden estricta relación con los objetivos y los
                        resultados comprometidos de la innovación propuesta</td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso4" id="ingreso4"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso14" id="ingreso14"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso24" id="ingreso24"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso34" id="ingreso34"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                <tr>
                    <td class="tg-hix7" colspan="2" align="center"><b>Difusión (10%)</b></td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso5" id="ingreso5"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso15" id="ingreso15"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso25" id="ingreso25"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso35" id="ingreso35"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                <tr>
                <td class="tg-hix7" colspan="2" align="center"><b>Gastos de Administración (5%)</b></td>
                  
                  
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso6" id="ingreso6"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso16" id="ingreso16"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso26" id="ingreso26"
                            onkeyup="return Suma()" onkeypress="return valida(event)" onpaste="return false" required>
                    </th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso36" id="ingreso36"
                            readonly="readonly" style="background-color:#B2B2B2" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                </tr>
                ...
                <tr>
                    <td class="tg-hix7" colspan="2" align="center"><b>Adquisición de Máquinas, Equipos e Insumos</b>
                    </td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso8" id="ingreso8" onkeyup="Suma()"
                            onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso18" id="ingreso18"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso28" id="ingreso28"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso38" id="ingreso38"
                            readonly="readonly" style="background-color:#B2B2B2" onpaste="return false" required></th>
                </tr>

                <tr>
                    <td class="tg-hix7" colspan="2" align="center"><b>Mobiliario</b></td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso9" id="ingreso9" onkeyup="Suma()"
                            onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso19" id="ingreso19"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso29" id="ingreso29"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso39" id="ingreso39"
                            readonly="readonly" style="background-color:#B2B2B2" onpaste="return false" required></th>
                </tr>

                <tr>
                    <td class="tg-hix7" colspan="2" align="center"><b>Infraestructura (10%)</b></td>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso10" id="ingreso10"
                            onkeyup="Suma()" onblur="Calculo()" onkeypress="return valida(event)" onpaste="return false"
                            required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso110" id="ingreso110"
                            onkeyup="Suma()" onkeypress="return valida(event)" onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="text" maxlength="9" name="ingreso210" id="ingreso210"
                            onkeyup="Suma()" onblur="Pecunario()" onkeypress="return valida(event)"
                            onpaste="return false" required></th>
                    <th class="tg-hix7"><input type="number" maxlength="9" name="ingreso310" id="ingreso310"
                            readonly="readonly" style="background-color:#B2B2B2" onpaste="return false" required></th>
                </tr>

                <tr>
                    <td align="right" colspan="2"> <b>TOTALES PROYECTO</b></td>
                    <th><input maxlength="9" type="number" name="proy_total" id="proy_total" readonly="readonly"
                            style="background-color:#B2B2B2" required /></th>
                    <th><input maxlength="9" type="number" name="proy_total1" id="proy_total1" readonly="readonly"
                            onpaste="return false" style="background-color:#B2B2B2" required /></th>
                    <th><input maxlength="9" type="number" name="proy_total2" id="proy_total2" readonly="readonly"
                            onpaste="return false" style="background-color:#B2B2B2" required /></th>
                    <th><input maxlength="9" type="number" name="proy_total3" id="proy_total3" readonly="readonly"
                            onpaste="return false" style="background-color:#B2B2B2" required /></th>
                </tr>
            </table>
