...
$sqlProyecto = "INSERT INTO proyecto (id, nombre, nombre_entidad, estado, tipo_proyecto) 
VALUES ('', '$nombreProyecto','$nombreEntidad','Pendiente', 'privados')";
...
$copiacertificadovigencia=$_FILES['archivo16']['name'];
$guardado16=$_FILES['archivo16']['tmp_name'];



//comprueba la ruta si existe
if(!file_exists('./proyectos/privados/'.$id_proyecto)){
    //crea carpeta para proyecto
    mkdir('./proyectos/privados/'.$id_proyecto,0777,true);
    //Consulta si se creo correctamente
	if(file_exists('./proyectos/privados/'.$id_proyecto)){
        //Mueve archivos a la ruta proyectos/privados/id_proyecto.
		if(move_uploaded_file($guardado, './proyectos/privados/'.$id_proyecto.'/'.$anexo_2)){
            
            move_uploaded_file($guardado2,  './proyectos/privados/'.$id_proyecto.'/'.$anexo_3);
            move_uploaded_file($guardado3,  './proyectos/privados/'.$id_proyecto.'/'.$grafico);
            move_uploaded_file($guardado4,  './proyectos/privados/'.$id_proyecto.'/'.$objetivosEspecificos);
            move_uploaded_file($guardado5,  './proyectos/privados/'.$id_proyecto.'/'.$anexo_6);
            move_uploaded_file($guardado6,  './proyectos/privados/'.$id_proyecto.'/'.$presupuestoDetallado);
            move_uploaded_file($guardado7,  './proyectos/privados/'.$id_proyecto.'/'.$resultadosEsperados);
            move_uploaded_file($guardado8,  './proyectos/privados/'.$id_proyecto.'/'.$indicadoresEvaluación);
            move_uploaded_file($guardado9,  './proyectos/privados/'.$id_proyecto.'/'.$cartaGantt);
            move_uploaded_file($guardado10, './proyectos/privados/'.$id_proyecto.'/'.$funcion_integrante);
            move_uploaded_file($guardado11, './proyectos/privados/'.$id_proyecto.'/'.$rolUnicoTributario);
            move_uploaded_file($guardado12, './proyectos/privados/'.$id_proyecto.'/'.$cedulaIdentidad);
            move_uploaded_file($guardado13, './proyectos/privados/'.$id_proyecto.'/'.$copiaSimpleInstrumento);
            move_uploaded_file($guardado14, './proyectos/privados/'.$id_proyecto.'/'.$cartaAutoridad);
            move_uploaded_file($guardado15, './proyectos/privados/'.$id_proyecto.'/'.$antecedentesRelevantes);
            move_uploaded_file($guardado16, './proyectos/privados/'.$id_proyecto.'/'.$copiacertificadovigencia);
            
            
            //Aqui debe subir ruta archivo
            
            $ruta1 =     "./proyectos/privados/$id_proyecto/$anexo_2";
            $ruta2 =     "./proyectos/privados/$id_proyecto/$anexo_3";
            $ruta3 =     "./proyectos/privados/$id_proyecto/$grafico";
            $ruta4 =     "./proyectos/privados/$id_proyecto/$objetivosEspecificos";
            $ruta5 =     "./proyectos/privados/$id_proyecto/$anexo_6";
            $ruta6 =     "./proyectos/privados/$id_proyecto/$presupuestoDetallado";
            $ruta7 =     "./proyectos/privados/$id_proyecto/$resultadosEsperados";
            $ruta8 =     "./proyectos/privados/$id_proyecto/$indicadoresEvaluación";
            $ruta9 =     "./proyectos/privados/$id_proyecto/$cartaGantt";
            $ruta10 =    "./proyectos/privados/$id_proyecto/$funcion_integrante";
            $ruta11 =    "./proyectos/privados/$id_proyecto/$rolUnicoTributario";
            $ruta12 =    "./proyectos/privados/$id_proyecto/$cedulaIdentidad";
            $ruta13 =    "./proyectos/privados/$id_proyecto/$copiaSimpleInstrumento";
            $ruta14 =    "./proyectos/privados/$id_proyecto/$cartaAutoridad";
            $ruta15 =    "./proyectos/privados/$id_proyecto/$antecedentesRelevantes";
            $ruta16 =    "./proyectos/privados/$id_proyecto/$copiacertificadovigencia";
            ...
            $sqlAnexos = "INSERT INTO anexos(id, id_proyecto, anexo_2, anexo_3, grafico_imagen, objetivos_especificos, anexo_6, presupuesto_detallado, resultados_esperados, indicador_evaluacion, carta_gantt, funcion_integrantes, copia_rol_tributario, copia_cedula_identidad, copia_instrumento, carta_autoridad, antecedentes_relevantes, copia_certificado_vigencia) 
                VALUES('', '$id_proyecto', '$ruta1', '$ruta2', '$ruta3', '$ruta4', '$ruta5', '$ruta6', '$ruta7', '$ruta8', '$ruta9', '$ruta10', '$ruta11', '$ruta12', '$ruta13', '$ruta14', '$ruta15', '$ruta16')";
...
$nuevo_path="../php/proyectos/privados/".$id_proyecto;
