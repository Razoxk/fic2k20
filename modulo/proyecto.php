...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p><a href="../php/proyectos/<?php echo $tipoProyecto;?>/<?php echo $idProyecto;?>/ComprobanteFIC.pdf">Descargar Comprobante FIC 2020</a></p>
        <hr class="my-4">
        <p>Nombre: <?php echo $nombreProyecto; ?></p>
        <p>Entidad: <?php echo $nombreEntidad; ?></p>
        <p>Tipo de proyecto: <?php echo $tipoProyecto; ?></p>
        <p>Estado: <?php echo $nombreEstado; ?> </p>
        <form name="estado" method="post">
        <select name="update">
            <option 1 value="">Pinche acá para cambiar el estado del proyecto</option>
