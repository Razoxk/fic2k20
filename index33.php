    ...
    <div class="site-wrapper-inner">
      <div class="cover-container">
        ...
        <div class="inner cover">
          <h1 class="cover-heading">Formulario Postulación FIC</h1>
          <p class="lead cover-copy">División de Fomento e Industria
            Gobierno Regional de O'Higgins</p>
          <p class="lead">
            <a class="btn btn-lg btn-default btn-notify" href="publico.php">Institución Pública</a>
            <a class="btn btn-lg btn-default btn-notify" href="privada">Institución Privada</a></p>
        </div>
        
        <div class="mastfoot">
          <div class="inner">
            <p>Designed by Hood</p>
          </div>
        </div>
